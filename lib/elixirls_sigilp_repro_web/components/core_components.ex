defmodule ElixirlsSigilpReproWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirlsSigilpReproWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirlsSigilpReproWeb.Gettext, "errors", msg, opts)
    end
  end
